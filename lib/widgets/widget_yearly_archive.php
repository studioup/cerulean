 ...
 * @see WP_Widget
 */
class WP_Widget_Yearly_Archives extends WP_Widget {
	...
	public function __construct() {
		$widget_ops = array('classname' => 'widget_yearly_archive', 'description' => __( 'A yearly archive of your site&#8217;s Posts.') );
		parent::__construct('yearly_archives', __('Yearly Archives'), $widget_ops);
	}
	...
	public function widget( $args, $instance ) {
		...
		if ( $title ) {
			echo $args['before_title'] .'<span class="has-border">'. $title .'</span>'. $args['after_title'];
		}
...
function yearly_archives_register_widgets() {
	register_widget( 'WP_Widget_Yearly_Archives' );
}

add_action( 'widgets_init', 'yearly_archives_register_widgets' );
