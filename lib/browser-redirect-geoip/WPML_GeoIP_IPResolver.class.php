...
class WPML_GeoIP_IPResolver
{
	...
	function __construct()
	{
		...
		if($sitepress !== null){
			...
			$this->default_language = substr ( get_bloginfo('language') , 0 , 2 ) ;
		}
		...
		$this->db = geoip_open(get_stylesheet_directory() . '/lib/browser-redirect-geoip/database/GeoIP.dat', GEOIP_STANDARD);
	}
	/**
